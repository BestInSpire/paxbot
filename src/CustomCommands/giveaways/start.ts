      ...
      message
        ...
        .then(async (msg) => {
          ...
          const winnerFilter = (m: any) =>
            !isNaN(m.content) && m.author.id === message.author.id;
          const prizeFilter = (m: any) => m.author.id === message.author.id;
            ...
            .then(async (channelAnswer) => {
              ...
              msg
                .edit({
                  embeds: [
                    embedCreate(
                      "Çekiliş süresini girmelisin! Örn: `15m` (15 dakika)"
                    ),
                  ],
                })
                .then(() => {
                                ...
                                .then(() => {
                                  msg.channel
                                    ...
                                    .catch(() =>
                                      msg.edit({
                                        content:
                                          "Süre doldu veya başka bir hata oluştu!",
                                        embeds: [],
                                        components: [],
                                      })
                                    );
