        ...
        .then((msg) => {
          ...
          collector.on("collect", (i) => {
            ...
            const embed = new MessageEmbed()
              ...
              .addField(
                "Çekilişin Kazanan Sayısı:",
                `${selectedGiveaway?.winnerCount}`
              )
            ...
            msg
              .edit({
                content:
                  "Hangi özelliğini değiştirmek istediğinizi butonlardan seçin!",
                components: [buttons],
                embeds: [embed],
              })
              .then((msg2) => {
                      ...
                      .edit({
                        ...
                        embeds: [
                          new MessageEmbed()
                            .setColor(`#${process.env.EMBEDCOLOR}`)
                            .setDescription(
                              "> Seçilecek yeni kazanan sayısını yaz!"
                            )
                            .setFooter({
                              text: "Bu mesajı cevaplandırmak için 2 dakikanız var!",
                            }),
