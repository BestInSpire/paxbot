...
export default (client: ClientType) =>
  new CustomCommands({
    props: {
      name: "çekiliş-iptal",
      aliases: ["giveaway-delete", "çekilişiptal", "giveawaydelete"],
      category: "Çekiliş",
      description: "Devam eden bir çekilişi iptal edersiniz!",
      usage: "!çekiliş-iptal",
      enabled: true,
      owner: false,
      nsfw: false,
    ...
    execute: (message: Message, args: string[]) => {
      ...
      message
        .reply({
          content: "İptal etmek istediğin çekilişi listeden seç!",
        ...
        .then((msg) => {
          ...
          collector.on("collect", (i) => {
            ...
            giveawaysManager
              .delete(`${selectedGiveaway?.messageId}`)
              .then(() => {
                msg.edit({
