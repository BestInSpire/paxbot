                ...
                .then(() => {
                  ...
                  msg.channel
                    ...
                    .then(async (nameAnswer) => {
                      let namexd: Message<boolean> | undefined =
                        nameAnswer.first();
                      ...
                      if (!data) {
                        msg
                          .edit({
                            ...
                            embeds: [
                              embedCreator(
                                "Eklemek istediğin komutun açıklamasını gir"
                              ),
                            ],
                          })
                          .then(() => {
              ...
              if (dataArray.length < 1) {
                ...
                msg
                  ...
                  .then(() => {
                    ...
                    selectMenuCollector.on("collect", async (i: any) => {
                      const selectedDataxd =
                        await dataModels.customCommands.findOne({
                          name: i.values[0],
                        });
                      msg
                        .edit({
